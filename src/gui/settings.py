...
def init():
    ...
    global exempting_students, using_custom_exlabels, attendance_only, using_with_points, no_eval_ex0, using_lab0, not_using_failed_points  # BooleanVar
    ...
    using_with_points = BooleanVar(value=False)
